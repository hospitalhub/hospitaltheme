...
<div class="row">
	...
	<!-- BIP --!>
                    <div class="panel panel-default" style="border:none;">
                        <div class="panel-heading" style="padding: 0px 16px;">
                           <a data-toggle="collapse" data-parent="#accordion" style="padding: 3px;" href="#bip">
                             <h2 class="panel-title" style="font-size: 18px;">BIP <i style="vertical-align:middle; color: #ddd;" class="fa fa-arrow-down"></i></h2>
                          </a>
                        </div>
                        <div id="bip" class="panel-collapse collapse">
                            <div class="panel-body" style="padding: 0px;">
                                <ul>
                                    <li><a class="fa" style="font-size:15px;" href="http://szpital.kalisz.pl/wp/biuletyn-informacji-publicznej"><i class="fa fa-ambulance"></i> Biuletyn Informacji Publicznej</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
